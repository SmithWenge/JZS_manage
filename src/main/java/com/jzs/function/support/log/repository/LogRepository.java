...
public class LogRepository implements LogRepositoryI {
    ...
    public void insertLog(LogContent logContent) {
        String sql = "INSERT INTO jzs_log (logAction, logLevel, logContent, logUser) VALUES (?, ?, ?, ?)";
        Object[] args = {
    ...
    public Page<LogContent> select4Page(LogContent logContent, Pageable pageable) {
        StringBuilder sql = new StringBuilder("SELECT logId, logAction, logLevel, logContent, logUser, logTime FROM jzs_log WHERE deleteFlag = 0");
