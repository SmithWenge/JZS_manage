...
<div class="panel panel-default" style="float: left;width: 85%;">
  ...
  <div class="panel-body">
    <div class="row" style="margin-top: 5px;">
      ...
      <div class="col-md-12">
        <form class="form-horizontal" action="${contextPath}/admin/worker/edit.action" method="post" id="addForm">
          <input type="hidden" name="userId" value="${worker.userId}">
          <div class="form-group">
            <label for="userName" class="col-sm-2 control-label">工人姓名</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="userName" placeholder="张三" name="userName" value="${worker.userName}">
            </div>
          </div>
          <div class="form-group">
            <label for="userGender" class="col-sm-2 control-label">选择性别</label>
            <div class="col-sm-10">
              <tags:dicselect name="userGender" key="adminGender" value="${worker.userGender}" id="userGender" />
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="userTelOne" name="userTelOne" value="${worker.userTelOne}">
            </div>
          </div>
          <div class="form-group">
            <label for="userTelTwo" class="col-sm-2 control-label">电话2</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="userTelTwo" placeholder="可以为空" name="userTelTwo" value="${worker.userTelTwo}">
            </div>
          </div>
          <div class="form-group">
